    ...
    schema.update(
        {
            ...
            "商品出现方式": "写商品出现时机、自然程度、是否强种草，以及和前文问题是否接上。",
            "达人说服方式": "写核心说服链路：靠身份、经验、对比、成分、孩子反馈、价格还是情绪；同时写强弱点。",
...
def build_prompt(record: dict[str, Any]) -> str:
    ...
    return (
        ...
        "结果会被渲染成 2B 深拆报告：S层命中人群 -> 前三秒/首图 -> 中段承接 -> 标题/字幕/画面关系 -> 商品出现方式 -> 说服方式 -> 真实感 -> 四项互动归因。\n"
