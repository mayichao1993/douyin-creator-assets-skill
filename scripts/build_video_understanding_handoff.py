    ...
    schema.update(
        {
            ...
            "达人说服方式": "非挂车内容只写怎么让用户继续看下去：入口期待、中段回答、情绪推进、信息递进或画面递进分别起什么作用；不要写成更重的信任判断。挂车或明确商品推荐内容，才补充选择/购买相关的说服链。",
...
def build_prompt(record: dict[str, Any]) -> str:
    ...
    return (
        ...
        "结果会被渲染成 2B 深拆报告：S层命中人群 -> 前三秒/首图 -> 中段承接 -> 标题/字幕/画面关系 -> 继续看方式 -> 真实感 -> 四项互动归因。\n"
        ...
        "非挂车内容的“继续看方式”只看怎么让用户继续看下去，不要写成更重的信任判断。\n"
        "2B 只看内容本身；商品只在标题、画面或挂车明确出现时作为事实并入继续看方式或标题/画面关系，不做额外承接推导。\n"
