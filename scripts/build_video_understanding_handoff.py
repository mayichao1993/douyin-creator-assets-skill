    ...
    schema.update(
        {
            ...
            "达人说服方式": "写核心说服链路：靠身份、经验、对比、成分、孩子反馈、价格还是情绪；同时写强弱点。2B 只看内容本身；商品只在标题、画面或挂车明确出现时作为说服链事实写入，不做额外承接推导。",
            "内容真实感": "写真实感评级和原因，并说明真实感有没有转成有效说服。",
...
def build_prompt(record: dict[str, Any]) -> str:
    ...
    return (
        ...
        "结果会被渲染成 2B 深拆报告：S层命中人群 -> 前三秒/首图 -> 中段承接 -> 标题/字幕/画面关系 -> 说服方式 -> 真实感 -> 四项互动归因。\n"
        ...
        "2B 只看内容本身；商品只在标题、画面或挂车明确出现时作为事实并入说服方式或标题/画面关系，不做额外承接推导。\n"
